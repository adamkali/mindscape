...
export function BookmarksResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BookmarksResponse {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(RepositoryBookmarkFromJSON)),
...
export function BookmarksResponseToJSONTyped(value?: BookmarksResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(RepositoryBookmarkToJSON)),
